...
class MlpExtractor(nn.Module):
    ...
    def __init__(
        ...
        #last_layer_dim_aux = last_layer_dim_shared
    ...
    def forward(self, features: th.Tensor) -> Tuple[th.Tensor, th.Tensor]:
        ...
        #if(self.use_aux):
        #    return self.policy_net(shared_latent), self.value_net(shared_latent),self.aux_net(shared_latent)
        #else:
    ...
    """
    def forward_aux(self, features: th.Tensor) -> th.Tensor:
        return self.aux_net(self.shared_net(features)) 
    """
