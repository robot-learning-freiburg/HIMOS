...
from src.SB3.policies import MultiInputActorCriticPolicy
...
class BaseAlgorithm(ABC):
    ...
    def __init__(
        ...
        if isinstance(policy, str) and policy == "MultiInputPolicy":
            self.policy_class = MultiInputActorCriticPolicy#get_policy_from_name(policy_base, policy)
        else:
