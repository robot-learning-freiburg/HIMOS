...
from src.SB3.cat_dist import CategoricalMasked
...
class CategoricalDistribution(Distribution):
    ...
    def __init__(self, action_dim: int, **kwargs):
        ...
        self.action_dim = action_dim
        self.invalid_action_masking = kwargs['invalid_action_masking']
    ...
    def proba_distribution(self, action_logits: th.Tensor, action_mask: th.Tensor, device,softmax_annealing=False) -> "CategoricalDistribution":
        if self.invalid_action_masking:
            self.distribution = CategoricalMasked(logits=action_logits,mask=action_mask,device=device,softmax_annealing=softmax_annealing)
        else:
